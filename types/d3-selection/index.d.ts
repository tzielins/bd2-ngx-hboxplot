...
export type ValueFn2<T extends BaseType, Datum, Result> =
  (this: T, event: MouseEvent, datum: Datum) => Result;
...
export interface TransitionLike<GElement extends BaseType, Datum> {
    ...
    on(type: string, listener: ValueFn2<GElement, Datum, void>): TransitionLike<GElement, Datum>;
...
export interface Selection<GElement extends BaseType, Datum, PElement extends BaseType, PDatum> {
    ...
    on(typenames: string, listener: ValueFn2<GElement, Datum, void>, capture?: boolean): this;
